    ...
    <Fragment>
      <div className="collection-item avatar">
        <i className="circle grey lighten-2 z-depth-2">
          <FontAwesomeIcon icon="user" className={comment.user.userType !== "admin" ? "indigo-text text-darken-2" : "cyan-text text-darken-1"} />
        </i>  
        <div>
          {/* User Type */}
          {user.userType === 'admin' ? (
            <span className="comment-user-type cyan darken-1 white-text z-depth-1">Admin</span>
          ) : (
            <span className="comment-user-type indigo darken-2 white-text z-depth-1">Teacher</span>
          )}
