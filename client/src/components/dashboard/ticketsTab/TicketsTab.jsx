        ...
        <div id="my-tickets" className="col s12 collection with-header">
          ...
          <div className="collection-header" style={{ paddingTop: '1.5em', paddingBottom: '1.5em' }}>
            <span style={styles.header} >
              {user && user.userType !== 'admin' ? 'Assigned Tickets' : 'My Tickets'} 
              {' '}
              {tickets && user && user.userType !== 'admin' ? (
                        ...
                        {filtered.length === 0 && (
                          <Fragment>
                            {active_filter !== 'all' ? (
                              ...
                              <Fragment>
                                {user && user.userType === 'teacher' && assigned.length === 0 && (
                                  <tr>
                                    <td className="center" colSpan="9">
                        ...
                        {filtered.length === 0 && (
                          <Fragment>
                            {active_filter !== 'all' ? (
                              ...
                              <Fragment>
                                {user && user.userType === 'admin' && owned.length === 0 && (
                                  <tr>
                                    <td className="center" colSpan="9">
