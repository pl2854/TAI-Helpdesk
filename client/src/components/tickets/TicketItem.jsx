  ...
  return (
    <tr className="hoverable">
      ...
      <td className="center">
        ...
        {' '}
        {/* Update Link for Ticket Owner and Assigned Teacher */}
        {(issuedBy._id === user._id || (user.userType === 'teacher' && ticket.assignedTo._id === user._id)) && (
          <a href="#!" onClick={onUpdate}>
            
          </a>
        )}
        {/* Update Link for Teachers on unassigned tickets */}
        {user.userType === 'teacher' && ticket.assignedTo.to === 'Unassigned' && (
          <a href="#!" onClick={onUpdate}>
