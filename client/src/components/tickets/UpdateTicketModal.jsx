            ...
            <div className="modal-content">
              ...
              <form onSubmit={onSubmit} styles={styles.modal}>
                ...
                <div className="row">
                  ...
                  <div className="form-group col s12 m6">
                    <label>Status</label>
                    {user._id !== current.ticket.issuedBy._id && user.userType === 'teacher' && assignedTo._id !== user._id ? (
                ...
                {/* Assigned */}
                <div className="row">
                  {/* If user = admin and owns the ticket : show Assign field*/}
                  {user && user.userType === 'admin' && user._id === current.ticket.issuedBy._id && (
                    <div className="form-group col s12">
                  ...
                  {/* If Ticket = Unassigned & user = teacher : show Assign field*/}
                  {user && user.userType === 'teacher' && (current.ticket.assignedTo.to === 'Unassigned' || current.ticket.assignedTo._id === user._id) && (
                    <div className="form-group col s12">
