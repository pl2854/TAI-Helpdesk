                ...
                <div className="row">
                  ...
                  <div className="col s12 m5 l4">
                    <div className="card-panel">
                      ...
                      {/* Show update action for Teachers if Ticket is Unassigned */}
                      {current.ticket.assignedTo.to === 'Unassigned' && user.userType === 'teacher' && (
                        <Fragment>
                          <div className="divider"></div>
                          <div className="center ticket-actions-header"></div>
                      ...
                      {/* Show Actions for Ticket owner && Assigned Teacher */}
